...
const Testimonials = () => {
    ...
    return (
        <div className="row" style={{ textAlign: 'center' }}>
            <div className="Group9" style={{ width: 950, height: 680, position: 'relative' }}>
                ...
                <div className="Content" style={{ width: 670, left: 140,paddingTop: '3vh', position: 'absolute', textAlign: 'center', color: 'black', fontSize: 20, fontFamily: 'Prompt', fontStyle: 'italic', fontWeight: '400', lineHeight: 3, letterSpacing: 0.60, wordWrap: 'break-word' }}>{currentTestimonial.content}</div>
                ...
                <div className="Name" style={{ left: 394, top: 375, position: 'absolute', textAlign: 'center', color: '#E0E0E0', fontSize: 19, fontFamily: 'Prompt', fontWeight: '500', textTransform: 'uppercase', lineHeight: 32, letterSpacing: 0.95, wordWrap: 'break-word' }}>{currentTestimonial.name}</div>
                <div className="Role" style={{ left: 394, top: 375, position: 'absolute', textAlign: 'center', color: '#B6BCCC', fontSize: 18, fontFamily: 'Prompt', fontWeight: '300', lineHeight: 32, wordWrap: 'break-word' }}>{currentTestimonial.role}</div>
